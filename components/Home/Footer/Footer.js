...
const Footer = () => {
    return (
        <div className='bg-black mt-8' id='footer'>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 md:pt-12">
                ...
                <div className="text-white text-center md:text-left">
                    <h1 className='text-[#E2861B] text-3xl font-semibold md:text-5xl'>Contact us</h1>
            ...
            <div className="flex justify-center space-x-4 md:space-x-6 py-10 md:py-10 md:pt-24">
                <a href="https://www.facebook.com/TweeSketch" rel='noreferrer' target="_blank"><FaFacebookF className='text-[#896B4B] text-3xl md:text-4xl' /></a>
                <a href="https://instagram.com/tweesketch2" rel='noreferrer' target="_blank"><FaInstagram className='text-[#896B4B] text-3xl md:text-4xl' /></a>
                <a href="https://www.linkedin.com/in/tweesketch" rel='noreferrer' target="_blank"><FaLinkedinIn className='text-[#896B4B] text-3xl md:text-4xl' /></a>
                <a href="https://www.youtube.com/channel/UC9cBQhXZba21ia90qPJ0Yvg" rel='noreferrer' target="_blank"><FaYoutube className='text-[#896B4B] text-3xl md:text-4xl' /></a>
            </div>
        </div>
    );
};
